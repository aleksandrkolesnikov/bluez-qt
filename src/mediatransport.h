...
{
    Q_OBJECT
    Q_PROPERTY(MediaCodec codec READ codec)
    Q_PROPERTY(State state READ state NOTIFY stateChanged)
    Q_PROPERTY(uint8_t volume READ volume NOTIFY volumeChanged)
...
public:
    ...
    /**
     * Returns the codec of the transport.
     *
     * @return codec of player
     */
    MediaCodec codec() const;
